**NOTE:** if you are just here to obtain a free copy of the game, fair enough, but please consider sharing the game with other people, or [supporting me financially](https://yolwoocle.itch.io/bugscraper) if you can. Thanks! 🙂
<br>
<div align="center">
  <h1>Bugscraper</h1>
</div>
...
However, I am very lax with what you can do with the source code. Please feel free to reuse, modify, or remix the source code of the game for any non commercial project, as long as you're not directly distributing the code.

If it does not fit that description please [contact me first](https://yolwoocle.com/about) (it's likely that I say yes!).   
