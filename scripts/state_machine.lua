--[[
	...
	> modified, based off: https://github.com/1bardesign/batteries/blob/master/state_machine.lua
	> licence at bottom of this file
...
function state_machine:init(states, start_in_state)
