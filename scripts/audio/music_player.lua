...
function MusicPlayer:init()
    ...
    self.disks = {
        ["ground_floor_empty"] = disk_class:new(
            self,
            sounds.music_ground_floor_empty_ingame.source,
            sounds.music_ground_floor_empty_paused.source,
            { volume = 0.75 }
        ),
        ["ground_floor_players"] = disk_class:new(
            self,
            sounds.music_ground_floor_players_ingame.source,
            sounds.music_ground_floor_players_paused.source,
            { volume = 0.75 }
        ),
        ...
        ["cafeteria"] = disk_class:new(
            self,
            sounds.music_cafeteria_ingame.source,
            sounds.music_cafeteria_paused.source
        ),
        ["cafeteria_empty"] = disk_class:new(
            self,
            sounds.music_cafeteria_empty_ingame.source,
            sounds.music_cafeteria_paused.source
        ),
