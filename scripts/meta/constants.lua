...
PARTICLE_LAYER_BACK_SHADOWLESS = 2
PARTICLE_LAYER_NORMAL = 3
PARTICLE_LAYER_SHADOWLESS = 4
PARTICLE_LAYER_HUD = 5
PARTICLE_LAYER_FRONT = 6

PARTICLE_LAYER_COUNT = 6 -- CHANGE THIS AFTER ADDING A PARTICLE LAYER
...
FONT_MINI_CHARACTERS =
    " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_abcdefghijklmnopqrstuvwxyz{|}~ÀÁÂÃÄÅĄÆÇĆÈÉÊËĘÌÍÎÏŁÐÑŃÒÓÔÕÖØÙÚÛÜŚÝŹŻÞßàáâãäåąæçćèéêëęìíîïłðñńòóôõöøùúûüśýþÿźżŒœ⁍"
