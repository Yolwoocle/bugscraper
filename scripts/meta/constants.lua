...
PARTICLE_LAYER_BACK = 2
PARTICLE_LAYER_BACK_SHADOWLESS = 3
PARTICLE_LAYER_NORMAL = 4
PARTICLE_LAYER_SHADOWLESS = 5
PARTICLE_LAYER_HUD = 6
PARTICLE_LAYER_FRONT = 7

PARTICLE_LAYER_COUNT = 7 -- CHANGE THIS AFTER ADDING A PARTICLE LAYER
