...
function Beelet:enter_wander() end
...
function Beelet:draw()
    ...
    if game.debug.colview_mode and self.detection_segment then
        line_color(
            COL_RED,
            self.detection_segment.ax,
            self.detection_segment.ay,
            self.detection_segment.bx,
            self.detection_segment.by
        )
        rect_color(
            COL_RED,
            "line",
            self.detection_segment.ax - self.player_detection_width / 2,
            self.detection_segment.ay - self.player_detection_width / 2,
            self.player_detection_width,
            self.player_detection_width
        )
    end
end
