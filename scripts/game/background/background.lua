...
function Background:change_bg_color(wave_n)
...
function Background:new_bg_particle()
	local o = {}
...
function Background:update_bg_particles(dt)
	-- Background lines
...
function Background:shift_to_red(speed_cap)
...
function Background:on_exploding_elevator(dt)
	self.bg_col = COL_BLACK_BLUE
