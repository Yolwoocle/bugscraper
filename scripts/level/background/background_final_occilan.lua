...
local BackgroundFinalOccilan = Background:inherit()

function BackgroundFinalOccilan:init(level)
...
function BackgroundFinalOccilan:init_bg_particles()
	self.bg_particles = {}	
...
function BackgroundFinalOccilan:update(dt)
...
function BackgroundFinalOccilan:set_speed(val)
	self.speed = val
end

function BackgroundFinalOccilan:change_clear_color(force_palette)
...
function BackgroundFinalOccilan:set_clear_color(palette)
...
function BackgroundFinalOccilan:new_bg_particle()
	local o = {}
...
function BackgroundFinalOccilan:update_bg_particles(dt)
	-- Background lines
...
function BackgroundFinalOccilan:shift_to_red(speed_cap)
...
function BackgroundFinalOccilan:on_exploding_elevator()
...
function BackgroundFinalOccilan:draw()
...
function BackgroundFinalOccilan:draw_particle(o)
	if o.type == "rect" then
		local y = o.y + o.oy
