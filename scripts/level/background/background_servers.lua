...
function BackgroundServers:init_edges()
    ...
    for iy = self.row_min_y, self.edge_max_y, self.row_height do
        ...
        insert_new_edge(
            row,
            new_edge( -- right horizontal edge
        ...
        for j = 1, 10 do -- flying bits
            insert_new_edge(
                ...
                new_point(
                    new_vec3(
                        random_range(x_left, x_right),
                        random_range(0, self.row_height),
                        random_range(1, self.max_z)
                    ),
                    5,
                    COL_WHITE
                )
