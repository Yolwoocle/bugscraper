...
function BackroomWithDoor:init()
    ...
    self.door = ElevatorDoor:new(
        186,
        154,
        images.cabin_door_light_left_far,
        images.cabin_door_light_left_center,
        images.cabin_door_light_right_far,
        images.cabin_door_light_right_center
    )
...
function BackroomWithDoor:draw_background() end

function BackroomWithDoor:draw_items()
    self.door:draw()
end

function BackroomWithDoor:draw_front_walls() end
