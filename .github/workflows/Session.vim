...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-cmake-syntax,~/.vim/plugged/copilot.vim,~/.vim/plugged/taboo.vim,~/.vim/plugged/vim-clang-format,~/.vim/plugged/vim-multiple-monitors,~/.vim/plugged/Highlight.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim91,/usr/share/vim/vim91/pack/dist/opt/netrw,/usr/share/vim/vimfiles/after,~/.vim/after
...
silent only
silent tabonly
cd ~/Documents/Projets/bugscraper/.github/workflows
...
badd +0 package-game.yaml
argglobal
%argdel
$argadd package-game.yaml
edit package-game.yaml
...
argglobal
terminal ++curwin ++cols=310 ++rows=38 
...
let s:l = 5234 - ((37 * winheight(0) + 19) / 38)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 56 - ((31 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 56
