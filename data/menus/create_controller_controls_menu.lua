...
local function create_controller_controls_menu(title, input_profile_id, player_n)
    return Menu:new(game, title, {
        ...
        {
            EnumOptionMenuItem,
            "🔘 {menu.options.input_submenu.controller_button_style}",
            "button_style_p" .. tostring(player_n),
            BUTTON_STYLES,
            "menu.options.input_submenu.controller_button_style_value",
        },
        {
            RangeOptionMenuItem,
            "🫨 {menu.options.input_submenu.vibration}",
            "vibration_p" .. tostring(player_n),
            { 0.0, 1.0 },
            0.2,
            "%",
            nil,
        ...
        {
            RangeOptionMenuItem,
            "🕹 {menu.options.input_submenu.deadzone}",
            "axis_deadzone_p" .. tostring(player_n),
            { 0.0, 0.95 },
            0.05,
            "%",
            function(self)
        ...
        { "" },
        {
            "🔄 " .. Text:text("menu.options.input_submenu.reset_controls"),
            function()
        ...
        },
        {
            ...
            INPUT_TYPE_CONTROLLER,
            "leave_game",
            "🔚 " .. Text:text("input.prompts.leave_game"),
        },
        { "" },
        ...
        { Text:text("menu.options.input_submenu.note_ui_min_button") },
        {
            ...
            INPUT_TYPE_CONTROLLER,
            "ui_left",
            "⬅ " .. Text:text("input.prompts.ui_left"),
        },
        {
            ControlsMenuItem,
            player_n,
            ...
            INPUT_TYPE_CONTROLLER,
            "ui_right",
            "➡ " .. Text:text("input.prompts.ui_right"),
        },
        {
            ControlsMenuItem,
            player_n,
        ...
        },
        {
            ...
            INPUT_TYPE_CONTROLLER,
            "ui_down",
            "⬇ " .. Text:text("input.prompts.ui_down"),
        },
        {
            ControlsMenuItem,
            player_n,
            ...
            INPUT_TYPE_CONTROLLER,
            "ui_select",
            "👆 " .. Text:text("input.prompts.ui_select"),
        },
        {
            ControlsMenuItem,
            player_n,
            ...
            INPUT_TYPE_CONTROLLER,
            "ui_back",
            "🔙 " .. Text:text("input.prompts.ui_back"),
        },
        {
            ControlsMenuItem,
            player_n,
