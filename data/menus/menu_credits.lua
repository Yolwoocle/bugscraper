...
return Menu:new(game, "{menu.credits.title}", {
    ...
    { Text:text("menu.credits.x_by_y", "'Snail Ball Run'", "Hector SK  (Nextop Games)"), empty_func },
    { Text:text("menu.credits.x_by_y", "'Bluescreen'", "Hector SK  (Nextop Games)"),    empty_func },
    { Text:text("menu.credits.x_by_y", "'Bluescreen (2)'", "418cat"),                   empty_func },
    ...
    { Text:text("menu.credits.x_by_y", "'Optical Studio'", "pkhead"),                   empty_func },
    { Text:text("menu.credits.x_by_y", "'Soon (TM)'", "pixelbath"),                     empty_func },
    { Text:text("menu.credits.x_by_y", "'You are a bug'", "kiwisky"),                   empty_func },
    { "" },
    { "" },
