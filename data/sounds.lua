...
sounds.music_ground_floor_players_paused =
    new_source("music/music_ground_floor_players_paused.ogg", "stream", { looping = true })
sounds.music_ground_floor_empty_ingame =
    new_source("music/music_ground_floor_empty_ingame.ogg", "stream", { looping = true })
sounds.music_ground_floor_empty_paused =
    new_source("music/music_ground_floor_empty_paused.ogg", "stream", { looping = true })
sounds.music_ground_floor_players_ingame =
    new_source("music/music_ground_floor_players_ingame.ogg", "stream", { looping = true })
...
for k, snd in pairs(sounds) do
    sounds[k] = Sound:new(snd, snd:getPitch(), snd:getVolume(), {
