...
sounds.music_boss_w1_ingame =  new_source("music/music_boss_w1_ingame.ogg",  "stream", {looping = true})
sounds.music_boss_w1_paused =  new_source("music/music_boss_w1_paused.ogg",  "stream", {looping = true})
